...
writeLines(growth_unif_stan, "random_growth_unif.stan")
...
simulate_theta_posterior_mixed <- function(nreps = 200, 
  ...
  filename_data =   paste(format(Sys.time(), "%b-%d-%Hh%M"),"-mixed-effects-growth-data-UNIF-",nsubjects,".csv",sep="")
  ...
  filename = paste(format(Sys.time(), "%b-%d-%Hh%M"),"-mixed-effects-growth-posterior-sample-UNIF-",nsubjects,".csv",sep="")
