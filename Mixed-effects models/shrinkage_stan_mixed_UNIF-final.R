...
writeLines(shrink_unif_stan, "random_shrink_unif.stan")
...
simulate_theta_posterior_mixed <- function(nreps = 200, 
  ...
  filename_data =   paste(format(Sys.time(), "%b-%d-%Hh%M"),"-mixed-effects-shrink-data-UNIF-",nsubjects,".csv",sep="")
  ...
  filename = paste(format(Sys.time(), "%b-%d-%Hh%M"),"-mixed-effects-shrink-posterior-sample-UNIF-",nsubjects,".csv",sep="")
