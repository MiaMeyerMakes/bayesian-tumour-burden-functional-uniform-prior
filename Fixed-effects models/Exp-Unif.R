...
exp_unif_statistics_table = rbind(stats15, stats50, stats100)
row.names(exp_unif_statistics_table) = c("n=15", "n=50", "n=100")
colnames(exp_unif_statistics_table) = c("CP_90", "CP_95", "ILE90", 
                               "ILE95", "MAE_mean", "MAE_median")
exp_unif_statistics_table

#       exp CP_90 CP_95      ILE90      ILE95   MAE_mean MAE_median
# n=15  exp_f  0.904 0.948 0.22681957 0.27970244 0.06893262 0.05553689
# n=50  exp_f  0.913 0.955 0.08703431 0.10510643 0.02062422 0.02018257
# n=100 exp_f  0.913 0.957 0.06013269 0.07206987 0.01480696 0.01469232
