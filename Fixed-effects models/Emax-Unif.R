...
emax_unif_statistics_table = rbind(emax_stats15, emax_stats50, emax_stats100)
row.names(emax_unif_statistics_table) = c("n=15", "n=50", "n=100")
colnames(emax_unif_statistics_table) = c("CP_90", "CP_95", "ILE90", "ILE95", "MAE_mean", "MAE_median")
emax_unif_statistics_table
#  emax_f  
