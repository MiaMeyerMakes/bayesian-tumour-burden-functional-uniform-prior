...
log_posterior <- function (theta0=0.2, theta1=0.6, theta2, sig2, x, y) {
  log_post = log_likelihood(theta0, theta1, theta2, sig2, x, y) + log_prior_theta + log_prior_sigma2(sig2)
  return(log_post)
}
...
power_unif_statistics_table = rbind(power_stats15, power_stats50, power_stats100)
row.names(power_unif_statistics_table) = c("n=15", "n=50", "n=100")
colnames(power_unif_statistics_table) = c("CP_90", "CP_95", "ILE90", "ILE95", "MAE_mean", "MAE_median")
power_unif_statistics_table
